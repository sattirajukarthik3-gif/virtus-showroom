...
for (const name of ['virtus', 'virtus.holo', 'engine']) { const glb = fs.readFileSync(`public/models/${name}.glb`); fs.writeFileSync(`public/models/${name}.json`, JSON.stringify({ b64: glb.toString('base64') })); }
